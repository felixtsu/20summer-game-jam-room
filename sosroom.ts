...
namespace sosroom{
    ...
    export function init() {
        ...
        scene.onOverlapTile(SpriteKind.Zhr, myTiles.zhrtile4, function (sprite, location) {
            if (zhrr钥 == 1) {
                tiles.setTilemap(tiles.createTilemap(hex``, img`
                    . . . . . . . . . . . . 2 . . . 
                    . . 2 2 2 2 . . . . . . 2 . . . 
                    . . . . . . . . . 2 2 . 2 . . . 
                    . . . . . . . . . . . . 2 . . . 
                    ...
                    . 2 2 . . . . . . . . . . . . . 
                    . . . . . . . . . . . . . . . . 
                    `, [myTiles.transparency16,sprites.castle.tileDarkGrass3,sprites.builtin.brick,myTiles.zhrtile1,myTiles.zhrtile4,sprites.dungeon.collectibleBlueCrystal,sprites.castle.tileDarkGrass1,sprites.castle.tileDarkGrass2,myTiles.zhrtile2], TileScale.Sixteen))
                tiles.setTileAt(tiles.getTileLocation(14, 5), sprites.castle.tileDarkGrass1)
            }
            if (zhrr钥 < 1) {
                Zhr.say("我没有钥匙。", 1000)
        ...
        tiles.setTilemap(tiles.createTilemap(hex``, img`
            ...
            . 2 2 . . . . . . . . . . . . . 
            . . . . . . . . . . . . . . . . 
            `, [myTiles.transparency16,sprites.castle.tileDarkGrass3,sprites.builtin.brick,myTiles.zhrtile1,myTiles.zhrtile4,sprites.castle.tileDarkGrass2,myTiles.zhrtile2,myTiles.zhrtile6], TileScale.Sixteen))
